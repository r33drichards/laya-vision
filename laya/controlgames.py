...
def model_policy(agent, game: str):
    """The model's most likely action from the rendered (ghosted) screen, via ``predict``. Plays the "single"
    frame mode only; ``autoresearch/games_eval.py`` plays every mode."""
