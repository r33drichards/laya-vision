...
- **Loss:** soft cross-entropy plus a strictly proper scoring rule (log + spherical, plus a ranked probability score for `score` questions), with the option order shuffled at random.
